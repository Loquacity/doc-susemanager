...
The menu:Inactive Systems[] page displays systems that have not checked in with {susemgr}
...
The menu:Proxy[] page displays the {susemgrproxy}
...
The menu:Provisioning[] tab and its subtabs allow you to schedule and monitor {ay}
...
If you use menu:Autoinstall by IP Address[], {susemgr}
